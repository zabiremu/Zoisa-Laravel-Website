...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">All SubScriber</h1>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom w-50">
                    <h3 class="card-title">All SubScriber Lists</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom w-100" id="responsive-datatable">
                            ...
                            <tbody>
                                @forelse ($allData as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('delete.subscriber', $item->id) }}" method="post">
                                                @csrf
                                            </form>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="2" class="text-center">No SubScriber</td>
                                    </tr>
                                @endforelse
